本项目基于osiris开发，若遇见bug欢迎反馈，正在找寻能接入漏扫的好项目或其他功能，若有好的web扫描器与MCP网关后端或开源前端，欢迎联系qq：1824675740

本项目较原项目基本无改动，仅添加部分功能与通用代理设置以及数据对齐，方便爬取使用
###核心开发点
...
| **制裁名单** | 个人/组织/船舶 SDN搜索 | OpenSanctions (美国OFAC SDN镜像) |
| **Telegram OSINT** | 公开频道的地理标记帖子 | `t.me/s/<channel>` 网页预览 |
